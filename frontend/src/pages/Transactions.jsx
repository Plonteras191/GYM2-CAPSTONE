  ...
  const handlePrintReceipt = (txn) => {
    ...
    printWindow.document.write(`
      <html>
        ...
        <body>
          <div class="center">
            <img src="${fullLogoUrl}" style="width: 50px; height: 50px; filter: grayscale(100%); margin-bottom: 5px;" onerror="this.style.display='none'" />
            <div class="bold" style="font-size: 16px;">DOUBLE ALPHA FITNESS</div>
          ...
          ${discountAmount > 0 ? `<div class="flex-between" style="font-size: 11px;"><span>Loyalty Discount:</span><span>-&#8369;${discountAmount.toFixed(2)}</span></div>` : ''}
          <div class="dashed-line"></div>
          <div class="flex-between"><span>Sub Total:</span><span>&#8369;${Number(txn.amount).toFixed(2)}</span></div>
          <div class="dashed-line"></div>
          <div class="flex-between bold" style="font-size: 15px;"><span>Total:</span><span>&#8369;${Number(txn.amount).toFixed(2)}</span></div>
          <br/>
          ...
          <div class="center" style="margin-top: 10px;">
            ...
            <div style="margin-top: 4px;">fb.com/doublealphafitnessgym</div>
          </div>
